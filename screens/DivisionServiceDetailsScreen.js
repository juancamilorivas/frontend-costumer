...
// const DivisionServiceDetailsScreen = ({ navigation }) => {
//   return (
...
// export default DivisionServiceDetailsScreen;
...
const DivisionServiceDetailsScreen = () => {
      ...
      <ScrollView>
        <View style={styles.mainContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate("ViewDetailsDivided", {
                shipmentNumber: serviceData.shipmentNumber,
              })
            }
          >
            <Text style={styles.titleFromTo}>Guia original</Text>
